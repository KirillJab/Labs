...
{
    if (strLen(word1) == strLen(word2) || (strLen(word2) - 1 == strLen(word1) && isPunct(word2[strLen(word2) - 1])))
    {
        int i = 0;
    ...
    while (text[i] != '\0')
    {
        ...
        if (check)
        {
            if(turn % 2)
            {
                ...
                {
                    k -= j;
                    if(!isPunct(word2[strLen(word2) - 1]))
                    {
                        k--;
                        buff[i + k] = word1[strLen(word1) - 1];
                        i++;
                        buff[i + k] = ' ';
                        k++;
                        printf("punct! ");
